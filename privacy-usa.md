...
**Phone-number validation providers.** For customers in the United States, we may disclose your telephone number to a third-party phone-number validation service so that it can be checked as described in section 4 (Phone number validation). Each such provider receives the telephone number only and, under its published terms, uses it solely to answer our request and does not retain it. This disclosure is made only for fraud prevention and security, not for marketing and not for any purpose of the provider's own.
...
For the same fraud-prevention purpose, we may also disclose your telephone number to a third-party phone-number validation service, which checks whether the number is valid and identifies its line type and network operator, uses it solely to answer our request, and does not retain it (see section 4 (Phone number validation) of the main Privacy Notice).
...
We also disclose telephone numbers to third-party phone-number validation services for fraud prevention and security, each of which receives the telephone number only and, under its published terms, uses it solely to answer our request and does not retain it (see section 7 (Phone-number validation providers) of the main Privacy Notice). This disclosure is not a sale or a share of your Personal Data.
