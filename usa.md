...
- **Minimum Term Subscriptions (MTS):** If your plan included $0 upfront hardware, it was provided on the condition that you complete a binding minimum number of future auto-renewing beer deliveries (as outlined at your checkout). If you need to cancel before hitting that minimum, no problem. You simply pay the one-time Deferred Hardware Charge (either $199 or $349, depending on the hardware you received) to buy out your contract and keep the machine.
...
- **"Delivery Plan"** means an auto-renewing, continuous subscription for recurring orders of Beer Packs shipped automatically on a flexible schedule controlled by the customer.  
- **"Minimum Term Subscription (MTS)"** means a Delivery Plan that includes a legally binding commitment to purchase a minimum number of future Beer Packs in exchange for discounted or $0 upfront Promotional Hardware.
...
**6.1 Minimum Term Subscription (MTS) Plans**

Under these plans, you receive Promotional Hardware for $0 upfront in exchange for a binding Minimum Term Subscription (MTS) agreement to purchase a minimum amount of future Pinter Packs. Ownership of the Promotional Hardware transfers to you upon delivery, subject strictly to your binding financial obligation to fulfill the MTS agreement or pay the Deferred Hardware Charge.

- **The Commitment:** You agree to pay for the minimum number of subsequent auto-renewing deliveries specified during your checkout and in your order confirmation.
...
- **Early Cancellation / Breach of Contract (After 30 Days):** If you fail to maintain an active payment method, or if you wish to cancel your Delivery Plan before completing your required MTS deliveries, your account will enter breach of contract. You may cure this by updating your payment method or paying the applicable Deferred Hardware Charge (see Section 8.3). Payment of this charge buys out your contract and settles the outstanding commitment.
...
A Deferred Hardware Charge represents the agreed retail value of the Promotional Hardware and is a legally enforceable contract buyout fee payable if promotional MTS Plan commitments are not fulfilled. 
...
- Until your MTS commitments are fulfilled or the Deferred Hardware Charge is paid in full, your account remains subject to collections for the outstanding balance of the hardware.
...
- **Standard Warranty:** Standard Pinter purchases and Minimum Term Subscription (MTS) plans are supplied with a standard manufacturer’s warranty. Full details, coverage, and exclusions are available at: https://pinter.com/pages/warranty
